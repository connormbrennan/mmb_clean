"""
Purpose:
    Copy exact legacy interaction-with-rules artifacts into this task.

Inputs:
    ../../../../legacy/mmb_upgraded/output/interactions_with_rules/
...
Run:
    make from tasks/mechanisms/interactions_with_rules/code/
"""
...
source_specs = [
    ("output/interactions_with_rules", "interactions_with_rules"),
]
