"""
Purpose:
    Copy exact paper-table artifacts into this task.

Inputs:
    ../../../../legacy/mmb_upgraded/output/paper_tables/
...
Run:
    make from tasks/paper/paper_tables/code/
"""
...
source_specs = [
    ("output/paper_tables", "paper_tables"),
]
