...
for path in sorted(legacy_dir.rglob("*")):
    ...
    if path.name == "Model_Characteristics_corrections.xlsx":
        ...
        disposition = "generated output; preserved exactly by a topic-specific task under tasks/graphs, tasks/measurement, tasks/mechanisms, or tasks/legacy"
    else:
...
with open(output_dir / "artifact_inventory.txt", "w", encoding="utf-8") as f:
    ...
    f.write("Exact generated artifacts are preserved by topic-specific tasks for parity checks and reference.\n")
