"""
Purpose:
    Copy exact legacy outcome coefficient plot artifacts into this task.

Inputs:
    ../../../../legacy/mmb_upgraded/output/coef_plots_outcomes/
    ../../../../legacy/mmb_upgraded/output/coef_plots_outcomes.zip
...
Run:
    make from tasks/measurement/outcome_coef_plots/code/
"""
...
source_specs = [
    ("output/coef_plots_outcomes", "coef_plots_outcomes"),
    ("output/coef_plots_outcomes.zip", "coef_plots_outcomes.zip"),
]
...
print(f"Copied {len(rows)} exact legacy artifacts.")
