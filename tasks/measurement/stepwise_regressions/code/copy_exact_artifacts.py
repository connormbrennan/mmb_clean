"""
Purpose:
    Copy exact stepwise-regression artifacts into this task.

Inputs:
    ../../../../legacy/mmb_upgraded/output/stepwise_regressions/
...
Run:
    make from tasks/measurement/stepwise_regressions/code/
"""
...
source_specs = [
    ("output/stepwise_regressions", "stepwise_regressions"),
]
