"""
Purpose:
    Copy exact legacy timing coefficient plot artifacts into this task.

Inputs:
    ../../../../legacy/mmb_upgraded/output/coef_plots_timing/
    ../../../../legacy/mmb_upgraded/output/coef_plots_timing.zip
...
Run:
    make from tasks/measurement/timing_coef_plots/code/
"""
...
source_specs = [
    ("output/coef_plots_timing", "coef_plots_timing"),
    ("output/coef_plots_timing.zip", "coef_plots_timing.zip"),
]
